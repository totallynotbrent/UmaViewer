...
namespace Gallop.Live.Cutt
{
    ...
    public class LiveTimelineWorkSheet : ScriptableObject
    {
        ...
        [SerializeField] public List<LiveTimelineGlobalFogData> globalFogDataLists = new List<LiveTimelineGlobalFogData>();
        ...
        [SerializeField] public LiveTimelineCameraLayerData cameraLayerKeys;
